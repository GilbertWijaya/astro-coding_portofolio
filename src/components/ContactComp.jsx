...
const ContactComp = () => {
    ...
    const sendToWhatsApp = () => {
        ...
        const noWa = "6282228000422"; // Ganti dengan nomor WA tujuan (format internasional, tanpa +)
        ...
        <>
            ...
            <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl text-center">
                    ...
                    <p className="mt-2 text-lg/8 text-gray-600">Contact us if the offer given does not match your wishes. We will give you something that satisfies you.</p>
                </div>
